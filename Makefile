...
ibot: code/bot/useless.cpp code/bot/read.cpp code/bot/relationship.cpp code/bot/save.cpp code/bot/population.cpp code/bot/cons_and_des_bot.cpp code/bot/main.cpp code/bot/turn.cpp code/bot/mutation.cpp
