...
ibot: code/bot/read.cpp code/bot/relationship.cpp code/bot/save.cpp code/bot/population.cpp code/bot/cons_and_des_bot.cpp code/bot/micro.cpp code/bot/turn.cpp code/bot/mutation.cpp
